...
const Layout = () => {
  return (
    <div className="w-full mx-auto px-4 py-4 md:px-6">
      <div className="w-full mx-auto px-3 md:px-8 mt-6 ">
        <h2 className="text-center text-3xl text-black md:text-[64px] font-bold md:leading-[96px]">
          Easy Way To Manage <br /> Your Over Work
        </h2>
        <p className="text-center text-gray-700 mt-7 max-w-2xl mx-auto">
          Looking for task management softwareto help you organise individual
          and team tasks in one shared space? With Tasky, it's easy to
          collaborate with your team
        </p>
        <div className="flex mx-auto justify-center mt-6 gap-3 items-center">
          <a
            href=""
            className="block bg-blue-700 rounded-full mt-2 text-center px-5 md:px-8 py-3 text-md md:text-lg font-semibold text-white"
          >
            Start Free Trial
          </a>
          <a
            href=""
            className="block border-black border md:border-2 rounded-full mt-2 text-center px-5 md:px-8 py-3 text-md md:text-lg font-semibold "
          >
            How it Works
          </a>
        </div>
      ...
      <div className="w-full mx-auto px-6 ">
        <h3 className="text-center md:text-3xl tracking-wide my-8 md:my-12 text-gray-700 font-bold">
          Trusted By over 65,000 customers world wide
        </h3>

        <div className="mx-auto justify-center flex flex-wrap gap-10 md:mt-4 ">
          <div className="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1">
            <svg
              className="h-5 mt-1 text-gray-800 fill-current "
          ...
          <div className="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
            <svg
              className="h-8 text-gray-800 fill-current"
      ...
      <div className="w-[95%] bg-[#f4faff] mx-auto px-8 md:px-16 py-20 md:mt-24 mt-12 flex items-center">
        <div className="w-2/5 h-auto px-6 md:px-10">
          ...
          <p className="text-gray-600 font-semibold mt-12">
            with multiple views, you can customize the way you visualize and
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
              ...
              <p className="mb-5 font-light text-gray-500 sm:text-xl">
                ...
                team's and orgainisation projects
              </p>
            </div>
      ...
      <section class="bg-blue-50 w-[95%] mx-auto rounded">
